...
meta_title: "htmx: l'alleato inatteso del backend moderno"
description: 'Scopri come htmx rivoluziona il frontend: interazioni dinamiche senza JavaScript, semplicità HTML, architetture serverless e vantaggi per lo sviluppo web moderno.'
date: 2025-09-13T05:00:00Z
image: /images/posts/post-36.png
categories:
  - Sviluppo
draft: false
---
...
<button hx-get="/heroes" hx-target="#hero-list">Carica Eroi!</button>
...
Vale la pena chiarire però che htmx non è un framework SSR.
