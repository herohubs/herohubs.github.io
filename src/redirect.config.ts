export const blogRedirects: Record<string, string> = {
  ...
  '/2024/12/05/hero-hubs-da-unidea-ad-una-nostra-realta-tecnologica': '/it/posts/42',
  ...
  '/2024/12/20/hero-hubs-2025-innovazione-crescita-ed-il-valore-della-collaborazione-nel-software': '/it/posts/43',
  ...
  // FEBRUARY 2025
  // ============================================
  '/2025/02/04/giancarlo-pedote-e-le-tempeste-dellinnovazione': '/it/posts/44',
  ...
  '/2025/02/20/hero-hubs-il-partner-tecnologico-per-il-software-b2b': '/it/posts/45',
  ...
  '/2025/03/06/6-segnali-che-indicano-che-il-tuo-software-aziendale-e-obsoleto': '/it/posts/46',
  ...
  '/t4di': '/it/posts/32',
  '/2025/04/17/retrotech-by-hero-hubs-linformatica-di-ieri-linnovazione-di-oggi': '/it/posts/47',
