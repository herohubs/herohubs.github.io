...
function J() {
  ...
  ((v.constructor = y), w(v, a.prototype), (v.isPureReactComponent = !0));
  var O = Array.isArray;
  function R() {}
  ...
  function T(t, e, u) {
    var r = u.ref;
    return { $$typeof: E, type: t, key: e, ref: r !== void 0 ? r : null, props: u };
  }
  function K(t, e) {
        ...
        case 'object':
          switch (t.$$typeof) {
            ...
            case I:
              ...
              break;
            case d:
              return ((i = t._init), _(i(t._payload), e, u, r, o));
          }
      }
    if (i)
      return (
        ...
        O(o)
          ? ((u = ''),
            i != null && (u = i.replace(j, '$&/') + '/'),
            _(o, e, u, '', function (Z) {
              return Z;
            }))
          : o != null &&
            (m(o) &&
              (o = K(o, u + (o.key == null || (t && t.key === o.key) ? '' : ('' + o.key).replace(j, '$&/') + '/') + i)),
            e.push(o)),
        1
      );
    i = 0;
    var p = r === '' ? '.' : r + ':';
    if (O(t)) for (var c = 0; c < t.length; c++) ((r = t[c]), (s = p + C(r, c)), (i += _(r, e, u, s, o)));
    else if (((c = G(t)), typeof c == 'function'))
      for (t = c.call(t), c = 0; !(r = t.next()).done; ) ((r = r.value), (s = p + C(r, c++)), (i += _(r, e, u, s, o)));
    else if (s === 'object') {
      if (typeof t.then == 'function') return _(W(t), e, u, r, o);
      throw (
        (e = String(t)),
        Error(
  ...
  var $ =
    ...
    X = {
      ...
      only: function (t) {
        if (!m(t)) throw Error('React.Children.only expected to receive a single React element child.');
        return t;
      },
    };
  return (
    ...
    (n.createContext = function (t) {
      return (
        (t = { $$typeof: U, _currentValue: t, _currentValue2: t, _threadCount: 0, Provider: null, Consumer: null }),
        (t.Provider = t),
        (t.Consumer = { $$typeof: k, _context: t }),
        t
      );
    }),
    (n.createElement = function (t, e, u) {
      ...
      if (e != null)
        for (r in (e.key !== void 0 && (s = '' + e.key), e))
          P.call(e, r) && r !== 'key' && r !== '__self' && r !== '__source' && (o[r] = e[r]);
      var i = arguments.length - 2;
      if (i === 1) o.children = u;
      else if (1 < i) {
        for (var p = Array(i), c = 0; c < i; c++) p[c] = arguments[c + 2];
        o.children = p;
      }
      if (t && t.defaultProps) for (r in ((i = t.defaultProps), i)) o[r] === void 0 && (o[r] = i[r]);
      return T(t, s, o);
    }),
    ...
    (n.isValidElement = m),
    (n.lazy = function (t) {
      return { $$typeof: d, _payload: { _status: -1, _result: t }, _init: Q };
    }),
    (n.memo = function (t, e) {
    ...
    (n.startTransition = function (t) {
      ...
      try {
        var r = t(),
          o = f.S;
        (o !== null && o(u, r), typeof r == 'object' && r !== null && typeof r.then == 'function' && r.then(R, $));
      } catch (s) {
        $(s);
      } finally {
...
var Y;
function V() {
  return (Y || ((Y = 1), (A.exports = J())), A.exports);
}
var F = V();
export { F as a, V as r };
